...
def generar_errores_similitud(nombre_completo, num_variantes, umbral_distancia):
    ...
    while len(variantes) < num_variantes:
        ...
        # Verificar si hay suficientes partes en el nombre completo
        if len(partes_nombre) < 2:
            print("El nombre completo debe tener al menos un nombre y un apellido separados por '/'. Por favor, inténtelo de nuevo.")
